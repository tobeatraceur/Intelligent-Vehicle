...
extern int direction;                      //小车运动状态：0-停止，1-前进，2-后退，3-向左，4-向右，5-左转，6-右转
extern long speed;                         //小车车轮速度绝对值
extern double location_x;                      //小车当前位置横坐标，runflag赋值处为原点
extern double location_y;                      //小车当前位置纵坐标，runflag赋值处为原点
extern double angle;                          //小车方位角
extern u8 runflag;                         //小车是否运动标志

extern float distance;              //超声波距离，单位cm
